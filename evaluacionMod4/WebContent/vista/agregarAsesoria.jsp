...
<body>
  ...
  <button type="button"  data-toggle="modal" data-target="#test1">Asesorias </button>
...
<div id="test1" class="modal fade" role="dialog" style="z-index: 1400;">
  <div class="modal-dialog">
	...
	<p>Tema </p>
		<input type="text" class="tema" name="tema">
	<p>Fecha </p>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Asesoria ingresada</h4>
        </div>
        <div class="modal-body">
          <p>Los datos de la asesoria se han ingresado con exito.</p>
